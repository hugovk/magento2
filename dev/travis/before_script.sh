...
case $TEST_SUITE in
    integration)
        ...
        test_set_size[1]=$(printf "%.0f" $(echo "$test_set_count*0.10" | bc))                   #10%
        test_set_size[2]=$(printf "%.0f" $(echo "$test_set_count*0.10" | bc))                   #10%
        test_set_size[3]=$(printf "%.0f" $(echo "$test_set_count*0.10" | bc))                   #10%
        test_set_size[4]=$((test_set_count-test_set_size[1]-test_set_size[2]-test_set_size[3])) #70%
